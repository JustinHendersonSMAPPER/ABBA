...
class OllamaAnalyzer:
    ...
    def analyze_verse_for_concept(self, 
                                 verse_text: str,
                                 concept_name: str,
                                 concept_description: str,
                                 verse_reference: str = None) -> SemanticAnalysisResult:
        ...
        prompt = self._create_concept_analysis_prompt(
            verse_text, concept_name, concept_description
        )
    ...
    def extract_concepts_from_verse(self, 
                                   verse_text: str,
                                   verse_reference: str = None) -> SemanticAnalysisResult:
    ...
    def batch_analyze_verses(self,
                           verses: List[Tuple[str, str]],  # (text, reference)
                           concept_name: str,
                           concept_description: str) -> List[SemanticAnalysisResult]:
        ...
        for i in range(0, total_verses, self.batch_size):
            ...
            for verse_text, verse_reference in batch:
                result = self.analyze_verse_for_concept(
                    verse_text, concept_name, concept_description, verse_reference
                )
    ...
    def _create_concept_analysis_prompt(self, 
                                      verse_text: str,
                                      concept_name: str,
                                      concept_description: str) -> str:
...
JSON Response:"""
    ...
    def _calculate_consensus(self, 
                           result: SemanticAnalysisResult,
                           parsed_responses: Dict[str, Dict[str, Any]]) -> SemanticAnalysisResult:
