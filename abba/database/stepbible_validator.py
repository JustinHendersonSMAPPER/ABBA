...
class STEPBibleValidator:
    ...
    EXPECTED_FILES = {
        ...
        'tahot_jos_est.txt': {'type': 'hebrew_text', 'books': ['Jos', 'Jdg', 'Rut', '1Sa', '2Sa', '1Ki', '2Ki', '1Ch', '2Ch', 'Ezr', 'Neh', 'Est']},
        'tahot_job_sng.txt': {'type': 'hebrew_text', 'books': ['Job', 'Psa', 'Pro', 'Ecc', 'Sng']},
        'tahot_isa_mal.txt': {'type': 'hebrew_text', 'books': ['Isa', 'Jer', 'Lam', 'Ezk', 'Dan', 'Hos', 'Jol', 'Amo', 'Oba', 'Jon', 'Mic', 'Nam', 'Hab', 'Zep', 'Hag', 'Zec', 'Mal']},
        'tagnt_mat_jhn.txt': {'type': 'greek_text', 'books': ['Mat', 'Mrk', 'Luk', 'Jhn']},
        'tagnt_act_rev.txt': {'type': 'greek_text', 'books': ['Act', 'Rom', '1Co', '2Co', 'Gal', 'Eph', 'Php', 'Col', '1Th', '2Th', '1Ti', '2Ti', 'Tit', 'Phm', 'Heb', 'Jas', '1Pe', '2Pe', '1Jn', '2Jn', '3Jn', 'Jud', 'Rev']},
    ...
    def _validate_file_completeness(self, conn: sqlite3.Connection) -> List[STEPBibleValidationResult]:
        ...
        if missing_files:
            results.append(STEPBibleValidationResult(
    ...
    def _validate_word_counts(self, conn: sqlite3.Connection) -> List[STEPBibleValidationResult]:
        ...
        if hebrew_count < self.MIN_EXPECTED_COUNTS['hebrew_words']:
            ...
            results.append(STEPBibleValidationResult(
                check_name="hebrew_word_count",
                passed=True,
                message=f"Hebrew word count verified: {hebrew_count:,}"
            ))
        ...
        if greek_count < self.MIN_EXPECTED_COUNTS['greek_words']:
            ...
            results.append(STEPBibleValidationResult(
                check_name="greek_word_count",
                passed=True,
                message=f"Greek word count verified: {greek_count:,}"
            ))
