...
def extract_translation(conn, translation_id, output_dir):
    ...
    trans_id, name, english_name, language, website, license_url, license_notes = trans_row
    ...
    for book_id, book_name, common_name, order, num_chapters in books:
        ...
        for chapter_num in range(1, num_chapters + 1):
            ...
            for verse_num, verse_text in verses:
                verse_data = {
                    "verse": verse_num,
                    "text": clean_verse_text(verse_text)
                }
...
def update_manifest(extracted_translations, output_dir):
...
def main():
    ...
    for trans_id, english_name, language in translations:
        try:
